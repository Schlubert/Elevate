...
const team: TeamMember[] = [
  {
    ...
    story: [
      ...
      "In 2006, Kevin and Esther bought Charlotte's French Bakery in Dunedin, the start of what would become Gilbert's Fine Food — a 20-year journey building a Dunedin institution known for authentic sourdough, European-style pastries, and an uncompromising commitment to real ingredients and sustainable practices.",
